  ...
  function purgeSession() {
      let prekey = []
      let directorio = readdirSync("./algnralgn")
      let filesFolderPreKeys = directorio.filter(file => {
          return file.startsWith('pre-key-')
      })
      prekey = [...prekey, ...filesFolderPreKeys]
      filesFolderPreKeys.forEach(files => {
      unlinkSync(`./algnralgn/${files}`)
  })
  ...
  conn.welcome = '*@user*\n -اﻧرټ ﻳروﺣﻲ 🫶'
  conn.bye = '*@user*\n\n*ﻣﻋسلاﻣﻪ ﺗروﺡاﻧﺕﻳﺟﻲغيرﻚاﻓﺧﻡﻣﻧك☻💔 \n\n\n\n لإيقاف رسائل الترحيب والمغادره يجب ان يكتب احد المشرفين هاذه الكلمة:\n .off welcome*'
  ...
  */
  ...
  let bio = `
  - ﭔﻗوﻟونَ انَ اﻟﺻواﻋق لا تضرب الا اﻟﻗﻣم اﻟشاﻣخه فانَ ڪُنَت تضنَ اﻧڪُكَ اﻟﻗﻣم فعلم انَي اﻟصاﻋقه...↢°𓅓`
  ...
  _quickTest()
  .then(() => conn.logger.info(`algnralgn．．．\n`))
  .catch(console.error)
